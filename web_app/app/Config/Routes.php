...
$routes->add('viewReviews', 'Professional::viewReviews');
$routes->add('reviewAppeal', 'Professional::reviewAppeal');
...
$routes->add('viewReviews', 'Provider::viewReviews');
$routes->add('reviewAppeal', 'Provider::reviewAppeal');
