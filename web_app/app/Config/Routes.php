...
$routes->add('professionalReviews', 'Manager::professionalReviews');
$routes->add('providerReviews', 'Manager::providerReviews');
$routes->add('professionalSelect', 'Manager::professionalSelect');
$routes->add('providerSelect', 'Manager::providerSelect');
...
$routes->add('handleProfessionalAppeal', 'Admin::handleProfessionalAppeal');
$routes->add('handleProviderAppeal', 'Admin::handleProviderAppeal');
$routes->add('dismissProfessionalAppeal', 'Admin::dismissProfessionalAppeal');
$routes->add('dismissProviderAppeal', 'Admin::dismissProviderAppeal');
