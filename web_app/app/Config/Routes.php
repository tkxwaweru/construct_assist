...
$routes->add('viewProfessionalAppeals', 'Admin::viewProfessionalAppeals');
$routes->add('viewProviderAppeals', 'Admin::viewProviderAppeals');
$routes->add('handleAppeal', 'Admin::handleAppeal');
$routes->add('dismissAppeal', 'Admin::dismissAppeal');
